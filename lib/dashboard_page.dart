...
class _DashboardPageState extends State<DashboardPage> {
  List<productdata> _produklist = [
    productdata(
      ...
      price: 49.00,
      img: 'asset/image/caminimint.png',
    ...
    productdata(
      ...
      price: 48.00,
      img: 'asset/image/caminiblue.png',
    ...
    productdata(
      ...
      price: 48.00,
      img: 'asset/image/caminichoral.png',
    ...
    productdata(
      ...
      price: 48.00,
      img: 'asset/image/caminipink.png',
    ...
    productdata(
      ...
      price: 48.00,
      img: 'asset/image/caminilavender.png',
...
class productdata {
  ...
  productdata(
      {this.jenisproduk, this.titleproduk, this.price, this.img, this.color});
}
